...
class PHPMailer
{
     ...
     * @type string
     */
    public $CharSet = 'iso-8859-1'; //'iso-8859-1';
     ...
     * @type string
     */
    public $From = 'news@smtp.ownserver.noticiadorweb.com.br';

    /**
     * The From name of the message.
     * @type string
     */
    public $FromName = 'NoticiadorWeb';
    ...
    public function wrapText($message, $length, $qp_mode = false)
    {
        ...
        // If iso-8859-1 encoding is used, we will need to make sure we don't
    ...
    /**
     * Find the last character boundary prior to $maxLength in a iso-8859-1
     * quoted (printable) encoded string.
     * Original written by Colin Brown.
     * @access public
     * @param string $encodedText iso-8859-1 QP text
